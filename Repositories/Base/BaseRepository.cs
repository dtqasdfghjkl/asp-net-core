...
namespace Backend.Repositories.Base
{
    public class BaseRepository<T> : IBaseRepository<T> where T : class
    {
        ...
        public virtual async Task<PaginatedResult<T>> GetPaginatedData(int pageNumber, int pageSize, CancellationToken cancellationToken = default)
        {
        ...
        public async Task<PaginatedResult<T>> GetPaginatedData(int pageNumber, int pageSize, Expression<Func<T, bool>> filter, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<PaginatedResult<T>> GetPaginatedData(List<Expression<Func<T, object>>> includeExpressions, int pageNumber, int pageSize, CancellationToken cancellationToken = default)
        {
            var query = _dbContext.Set<T>()
                .Skip((pageNumber - 1) * pageSize)
                .Take(pageSize)
        ...
        public async Task<PaginatedResult<T>> GetPaginatedData(int pageNumber, int pageSize, Expression<Func<T, bool>> filter, string sortBy, string sortOrder, CancellationToken cancellationToken = default)
        {
            var query = _dbContext.Set<T>().AsNoTracking();
